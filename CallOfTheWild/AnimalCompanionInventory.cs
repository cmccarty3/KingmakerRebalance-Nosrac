    ...
    class AnimalCompanionInventory
    {
       [Harmony12.HarmonyPatch(typeof(Inventory))]
        ...
        class CharDollBase__SetupInfo__Patch
        {
            ...
            static EquipSlotBase.SlotType[] allowed_slots_animal = new EquipSlotBase.SlotType[] { EquipSlotBase.SlotType.Belt, EquipSlotBase.SlotType.Neck, EquipSlotBase.SlotType.Wrist, EquipSlotBase.SlotType.Shoulders, EquipSlotBase.SlotType.Head, EquipSlotBase.SlotType.Armor };
